 ...
 */
router.get("/analytics/skills-gap", requireApiKey_1.requireApiKey, (0, requirePermission_1.requirePermission)("read:analytics"), async (_req, res, next) => {
    try {
 ...
 */
router.get("/analytics/employment-by-sector", requireApiKey_1.requireApiKey, (0, requirePermission_1.requirePermission)("read:analytics"), async (_req, res, next) => {
    try {
        const result = await (0, db_1.query)(`SELECT
 ...
 */
router.get("/analytics/job-titles", requireApiKey_1.requireApiKey, (0, requirePermission_1.requirePermission)("read:analytics"), async (_req, res, next) => {
    try {
        const result = await (0, db_1.query)(`SELECT
 ...
 */
router.get("/analytics/top-employers", requireApiKey_1.requireApiKey, (0, requirePermission_1.requirePermission)("read:analytics"), async (_req, res, next) => {
    try {
        const result = await (0, db_1.query)(`SELECT
 ...
 */
router.get("/analytics/usage-stats", requireApiKey_1.requireApiKey, (0, requirePermission_1.requirePermission)("read:analytics"), async (_req, res, next) => {
    try {
        const result = await (0, db_1.query)(`SELECT
           ak.client_name,
